...
void output_minmax_static(int (*matrix)[MAX_SIZE], int rows, int cols);
void output_minmax_dynamic(int **matrix, int rows, int cols);
...
int main() {
    ...
    switch (choice) {
        case 1:
            ...
            printf("\n");
            output_minmax_static(matrix, rows, cols);
            break;
...
void handle_dynamic(int **matrix, int rows, int cols) {
    ...
    printf("\n");
    output_minmax_dynamic(matrix, rows, cols);
    free_dynamic(matrix, rows);
}
